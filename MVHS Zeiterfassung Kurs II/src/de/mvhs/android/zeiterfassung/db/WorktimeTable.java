...
public class WorktimeTable {
	 ...
	 */
	public static final String CREATE_VIEW = "CREATE  VIEW  IF NOT EXISTS view_"
			+ TABLE_NAME
			+ " AS "
			+ " SELECT "
			+ COLUMN_ID + " AS " + COLUMN_ID + ","
			+ "DATE("
			+ COLUMN_START_TIME + ") AS " + COLUMN_SELECT_START_DATE + ","
			+ "TIME("
			+ COLUMN_START_TIME + ") AS " + COLUMN_SELECT_START_TIME + ","
			+ "DATE("
			+ COLUMN_END_TIME + ") AS " + COLUMN_SELECT_END_DATE + ","
			+ "TIME("
			+ COLUMN_END_TIME + ") AS " + COLUMN_SELECT_END_TIME + ","
			+ "CAST(STRFTIME('%s',"
			+ COLUMN_END_TIME + ") AS INTEGER) - CAST(STRFTIME('%s',"
			+ COLUMN_START_TIME + ") AS INTEGER) AS " + COLUMN_SELECT_WORK_TIME
			+ " FROM "
			+ TABLE_NAME;
	/**
