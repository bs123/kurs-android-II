...
public class AuflistungActivity extends ListActivity implements LoaderCallbacks<Cursor> {
  ...
  protected void onStart() {
    ...
    _Adapter = new SimpleCursorAdapter(this, // Context
            ...
            new int[] { R.id.start, R.id.ende }, // IDs der Views, in die die
            // Daten der Spalten
            // platziert werden
            0); // Flag
        ...
        builder.setTitle(R.string.title_delete).setMessage(R.string.delete_confirmation)
                .setPositiveButton(R.string.cmd_yes, new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(DialogInterface dialog, int which) {
                    getContentResolver().delete(Uri.withAppendedPath(ZeitContentProvider.CONTENT_URI, String.valueOf(info.id)), null, null);
                    getLoaderManager().restartLoader(_DATA_LOADER, null, AuflistungActivity.this);
                  }
  ...
  public Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    switch (id) {
      case _DATA_LOADER:
      case _EXPORT_LOADER:
        returnValue = new CursorLoader(this, ZeitContentProvider.CONTENT_URI, null, null, null, ZeitTabelle.STARTZEIT + " DESC");
        break;
