...
public class ZeitTabelle {
  // Konstanten
  private final static String          _CREATE_TABLE = "CREATE TABLE zeit (_id INTEGER PRIMARY KEY  AUTOINCREMENT NOT NULL," + "startzeit TEXT NOT NULL,"
                                                             + "endzeit TEXT)";

  private final static String          _DROP_TABLE   = "DROP TABLE IF EXISTS zeit";

  public final static SimpleDateFormat SDF           = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm");
