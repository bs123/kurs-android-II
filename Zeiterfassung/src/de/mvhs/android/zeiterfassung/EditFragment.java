...
public class EditFragment extends Fragment implements IRecordSelectedListener,
	...
	public void onStart() {
		...
		_SelectPicture = (Button) getActivity()
	...
	private void loadData() {
		...
		if (data != null && data.moveToFirst()) {
			...
			if (!data.isNull(data.getColumnIndex(Columns.LONGTITUDE))
				...
				_Position.setText(String
						.format("Lat: %,1.5f, Long: %,1.5f", data
								.getDouble(data
										.getColumnIndex(Columns.LATITUDE)),
								data.getDouble(data
	...
	private class OnRefreshGpsClicked implements
		...
		public void onClick(View v) {
			if (_locationManager != null) {
				...
				_Position.setText(String.format("Lat: %,1.5f, Long: %,1.5f",
						_Lat, _Long));
			}
		}
	}
