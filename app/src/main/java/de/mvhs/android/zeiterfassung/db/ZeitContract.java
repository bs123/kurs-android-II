...
public final class ZeitContract {
   ...
   public final static class ZeitDaten {
      ...
      /**
       * Unterverzeichnis für den nicht abgeschlossenen Datensatz
       */
      private final static String _EMPTY_DIRECTORY = "not_closed";
       ...
       * Verzeichnis in ContentProvider
       */
      public final static String EMPTY_CONTENT_DIRECTORY = _DATA_DIRECTORY + "/" + _EMPTY_DIRECTORY;
      ...
      /**
       * Uri für einen nicht geschlossenen Datensatz
       */
      public final static Uri EMPTY_CONTENT_URI = Uri.withAppendedPath(CONTENT_URI, _EMPTY_DIRECTORY);
