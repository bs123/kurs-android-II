...
public class EditActivity extends AppCompatActivity {
  ...
  protected void onStart() {
    ...
    _endDate.setOnLongClickListener(new OnDateDialogShow(this, _endDatTimeValue, _endDate));
    _endTime.setOnLongClickListener(new OnTimeDialogShow(this, _endDatTimeValue, _endTime));
  }
  @Override
